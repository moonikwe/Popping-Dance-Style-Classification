...
def validate(data_type, model, seq_length=0, saved_model=None,
...
def main():
    model = 'lstm'
    # saved_model = 'data/checkpoints/lstm-features.010-0.305.hdf5'
    saved_model = 'data/checkpoints/lstm-features.015-0.257.hdf5'
